...
class Num(metaclass=Metaclass_Num):
    ...
    def __init__(self, **kwargs):
        ...
        self.sensor_value = kwargs.get('sensor_value', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.sensor_value != other.sensor_value:
            return False
    ...
    def sensor_value(self, value):
        if __debug__:
            assert \
                ...
                "The 'sensor_value' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'sensor_value' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
