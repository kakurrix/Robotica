...
bool mensaje__srv__kinematics__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mensaje.srv._kinematics.Kinematics_Request", full_classname_dest, 42) == 0);
  }
  mensaje__srv__Kinematics_Request * ros_message = _ros_message;
  {  // theta1
...
PyObject * mensaje__srv__kinematics__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mensaje.srv._kinematics");
...
ROSIDL_GENERATOR_C_EXPORT
bool mensaje__srv__kinematics__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mensaje.srv._kinematics.Kinematics_Response", full_classname_dest, 43) == 0);
  }
  mensaje__srv__Kinematics_Response * ros_message = _ros_message;
  {  // pose
